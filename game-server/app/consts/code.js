module.exports = {
  ...
  ACCOUNT_OLD: {
    ...
    CARD_TYPE_ERROR: 30,
    CARD_NOT_EXISTS: 31,
    CARD_SERIAL_ERROR: 32,
    CARD_SERIAL_NOT_MATH: 33,

    FRIENDSHIP_EXISTS: 40,
  ...
  REGISTER_LANGUAGE: {
    ...
    BONUS: 'Bạn được tặng %s vàng, 1 tuần sử dụng miễn phí vé phòng thường và vật phẩm sửa thời gian'
  },
